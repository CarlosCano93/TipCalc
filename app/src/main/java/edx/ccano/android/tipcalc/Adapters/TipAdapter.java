package edx.ccano.android.tipcalc.Adapters;
...
public class TipAdapter extends RecyclerView.Adapter<TipAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.setOnItemClickLitener(element, onItemClickListener);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void setOnItemClickLitener(final TipRecord element, final OnItemClickListener onItemClickListener) {
